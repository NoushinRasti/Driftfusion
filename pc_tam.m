classdef pc_tam
    ...
    % pc_tam (Parameters Class) defines all the required properties for your
    % device. pc_tam.BUILDDEV builds a structure PO.DEV (where PO is a Parameters Object)
    ...
    % be rebuilt using pc_tam.BUILDDEV. The spatial mesh is a linear piece-wise mesh 
    ...
    methods
        ...
        function par = pc_tam
            ...
            par.dev  = pc_tam.builddev(par);
            % Build initial xmesh
            par.xx = pc_tam.xmeshini(par);
        end
       ...
       %% Conduction band gradients at interfaces
        ...
        %% Donor densities, F = distribution function class
